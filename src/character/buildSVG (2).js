...
`,
  ...
  if (isCoach) {
    // Grey sweater — tapered torso (broader shoulders, narrower waist) with a
    // ribbed V-neck collar and a hem band, instead of a flat rectangle body.
    bodySVG = `
...
break;
  ...
  return `<svg viewBox="0 0 160 240" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:100%;overflow:visible">
    ...
    <g opacity=".4" style="mix-blend-mode:multiply">
      <path d="M50 140 Q55 170 50 210" fill="none" stroke="${darken(b,38)}" stroke-width="6" stroke-linecap="round"/>
      <path d="M70 134 Q74 170 70 214" fill="none" stroke="${darken(b,38)}" stroke-width="5" stroke-linecap="round"/>
    </g>
    <g opacity=".5" style="mix-blend-mode:screen">
      <path d="M92 134 Q96 170 92 214" fill="none" stroke="${lighten(b,30)}" stroke-width="5" stroke-linecap="round"/>
      <path d="M110 140 Q114 170 110 210" fill="none" stroke="${lighten(b,30)}" stroke-width="6" stroke-linecap="round"/>
    </g>
