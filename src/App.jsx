...
function buildSVG(charOrKey, mood, isTalking) {
  ...
  if (isCoach) {
    ...
    switch(roleKey) {
      ...
      case "blind_date":
        backProps = `
          <rect x="8" y="108" width="144" height="12" rx="6" fill="#241A14"/>
          <rect x="8" y="112" width="8" height="80" rx="4" fill="#241A14"/>
          <rect x="144" y="112" width="8" height="80" rx="4" fill="#241A14"/>
          <rect x="8" y="172" width="18" height="20" rx="4" fill="#241A14"/>
          <rect x="134" y="172" width="18" height="20" rx="4" fill="#241A14"/>`;
        bodySVG = `<rect x="42" y="130" rx="14" width="76" height="90" fill="${b}"/>
          ...
          ${armL}${armR}`;
        frontProps = `
          <rect x="10" y="188" width="140" height="18" rx="8" fill="#2A1E18"/>`; break;
