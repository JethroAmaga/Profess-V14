  ...
  if (screen === "landing") {
    ...
    return (
      <div className="screen-enter" style={{ ...BASE, height:"100vh", overflow:"hidden", position:"relative" }}>
        ...
        {/* Coach silhouette watermark — right side */}
        <div style={{ position:"absolute", right:"-2vw", bottom:"0", width:"30vh", height:"38vh", opacity:.06, pointerEvents:"none", zIndex:1 }}
        ...
        <div style={{ position:"relative", zIndex:2, height:"100vh", display:"flex", flexDirection:"column", alignItems:"flex-start", justifyContent:"center", padding:"0 40px 0 clamp(40px,8vw,140px)" }}>
          <div style={{ maxWidth:"640px", width:"100%", display:"flex", flexDirection:"column", gap:"24px" }}>
            {/* Label above tagline */}
            <p style={{ fontSize:"9px", letterSpacing:".2em", textTransform:"uppercase", color:"#2A2520" }}>Communication Training</p>
            {/* Tagline */}
            ...
            {/* Rule under tagline */}
            <div style={{ width:"80px", height:"1px", background:"#C8A870" }}/>
